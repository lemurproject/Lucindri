...
public class IndriBandWeightOld extends IndriWeight {

	private final ArrayList<Weight> weights;
	private final ScoreMode scoreMode;
	private final float boost;

	public IndriBandWeightOld(IndriBandQuery query, IndexSearcher searcher, ScoreMode scoreMode, float boost)
			throws IOException {
